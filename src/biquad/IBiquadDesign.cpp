...
void IBiquadDesign::vProcessBlock(float *inputBlock, size_t numSamples)
{
    for (size_t i = 0; i < numSamples; ++i) {
        float in = inputBlock[i];
...
void IBiquadDesign::vProcessBlockFix(s32 *inputBlock, size_t numSamples)
{
    for (size_t i = 0; i < numSamples; ++i) {
        s32 in = inputBlock[i];
